...
These are the default (0.3.7-R2-1-1) SA:MP PAWN include files but with documentation comments added. The documentation has been sourced from the (now defunct) SA:MP wiki, with many fixes applied and extra missing or extended information added.
